      ...
      <div className="">
        <div className="grid grid-cols-12  border-b-2 border-gray-300/90 px-8 py-4">
          <div className="flex justify-between col-span-12">
            ...
            <div>
            <ul className=' flex mr-40 gap-3'>
            <li className="flex items-center justify-center rounded-full border-2 border-current p-1 text-black hover:bg-blue-700 hover:text-white"><i className="fab fa-instagram"></i></li>
            <li className="flex items-center justify-center rounded-full border-2 border-current p-1 text-black hover:bg-blue-700 hover:text-white"><i className='fab fa-facebook'></i> </li>
            <li className="flex items-center justify-center rounded-full border-2 border-current p-1 text-black hover:bg-blue-700 hover:text-white"><i className='fab fa-tiktok'></i> </li>
            <li className="flex items-center justify-center rounded-full border-2 border-current p-1 text-black hover:bg-blue-700 hover:text-white"><i className='fab fa-twitter'></i> </li>
            <li className="flex items-center justify-center rounded-full border-2 border-current p-1 text-black hover:bg-blue-700 hover:text-white"><i className='fab fa-linkedin'></i> </li>
            <li className="flex items-center justify-center rounded-full border-2 border-current p-1 text-black hover:bg-blue-700 hover:text-white"><i className='fab fa-youtube'></i> </li>
          </ul>
            </div>
