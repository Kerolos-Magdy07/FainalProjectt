  ...
  return (
    <>
      <form
        ...
        className="mx-auto mt-10 max-w-2xl px-8 py-2"
      >
        ...
        <div className="mx-auto ">
          <h6 className="text-center mb-5 font-semibold">
             Don't You Have An Account  ?{" "}
            <Link to={"/register"}>
              {" "}
              <span className="text-blue-800 text-lg  font-semibold">Register Now</span> 
            </Link>
          </h6>
          ...
          <h6 className="text-center font-semibold">
            ...
            <Link to={"/forgetpassword"}>
              {" "}
              <span className="text-blue-800 text-lg  font-semibold">Forget Password</span>
            </Link>
          </h6>
        </div>
      </form>
